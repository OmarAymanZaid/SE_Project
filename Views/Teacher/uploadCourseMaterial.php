<?php
    ...
    if (isset($_POST["uploadMaterial"])) 
    {
        ...
        $location = "../files/material/"  . date("h-i-s") . " " . $_FILES["material"]["name"];
        $materialName = "[" . $_POST['courseName'] . "]" . $_FILES["material"]["name"];

        if (move_uploaded_file($_FILES["material"]["tmp_name"], $location))
        {
          if ($fileController->uploadMaterial($_POST['courseID'] ,$materialName ,$location)) 
          {
...
<body>
    ...
    <div class="card-body" style="padding:15px">
            <form class="card-body" action="uploadCourseMaterial.php" method="POST" enctype="multipart/form-data">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="fallback">
                                <input name="material" type="file" multiple>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-grid mt-3">
                        <button type="submit" class="btn btn-primary" name="uploadMaterial"> Add </button>
                    </div>
            </form>
        </div>
